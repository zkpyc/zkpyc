...
use crate::utilities::proof;
use crate::utilities::{wit_comp::StagedWitCompEvaluator, r1cs::{ProverData, VarType, Var, VerifierData}, cp_link};
...
impl<'a, F: PrimeField + PrimeFieldBits> CcCircuit<F> for SynthInput<'a, F> {
        ...
        CS: CcConstraintSystem<F>,
    {
        ...
        let mut uses: HashMap<Var, usize> =
