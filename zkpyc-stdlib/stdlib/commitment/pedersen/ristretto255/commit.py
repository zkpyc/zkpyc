...
from zkpyc.stdlib.ecc.doppioParams import DOPPIO_PARAMS
from zkpyc.stdlib.commitment.pedersen.ristretto255.hash512bitBool import pedersen_no_compress
from zkpyc.stdlib.hashes.pedersen.ristretto255.generators import G_table
from zkpyc.stdlib.hashes.pedersen.ristretto255.generators import H_table
...
def commit_int(x: Array[int, 16], r: Array[int, 16]) -> Array[int, 8]:
    ...
    commitment:  Array[bool, 256] = edwardsCompress(add(input_hash, blinding_hash, DOPPIO_PARAMS))
