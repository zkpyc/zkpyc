from zkpyc.types import Public, Array # zk_ignore
from zkpyc.stdlib.hashes.sha256.shaRound import shaRound
...
def hash(a: Array[Array[int, 16], 1], N: int) -> Array[int, 8]:
