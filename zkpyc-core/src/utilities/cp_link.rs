...
pub struct CommitKey<E: Engine> {
    #[serde(with = "super::mirage::serde_group_vec")]
    pub data_keys: Vec<E::G1Affine>,
    #[serde(with = "super::mirage::serde_group")]
...
pub struct ProvingKey<E: Engine> {
    data_len: usize,
    num_cmts: usize,
    #[serde(with = "super::mirage::serde_kw15_pk")]
...
pub struct VerifyingKey<E: Engine> {
    num_cmts: usize,
    #[serde(with = "super::mirage::serde_kw15_vk")]
...
pub struct Proof<E: Engine> {
    #[serde(with = "super::mirage::serde_kw15_pf")]
    inner: kw15::Proof<E>,
}
