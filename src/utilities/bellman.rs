...
use crate::utilities::proof::{self, ProofSystem};
use crate::utilities::r1cs::{Lc, ProverData, Var, VarType, VerifierData};
use crate::utilities::wit_comp::StagedWitCompEvaluator;
...
impl<E: Engine> ProofSystem for Bellman<E>
where
    E: MultiMillerLoop,
    E::G1: WnafGroup,
    E::G2: WnafGroup,
